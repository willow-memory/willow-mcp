...
* **gate:** the steward is a named second principal — steward_* groups from the live tick's verbs, gitsync_sweep and git_pull_execute off envelope_apply, a willow-bot manifest template ([faee2ed](https://github.com/willow-memory/willow-mcp/commit/faee2ed834ee4cb6b7d17a7b44f6d4a5bbcb8c3b))
...
* **fleet-seams:** CI fix for [#619](https://github.com/willow-memory/willow-mcp/issues/619) -- manifest permissions + robust sig test ([b302927](https://github.com/willow-memory/willow-mcp/commit/b302927cd88fbecdf541a043f19b0c35a0024fa3))
...
* one handoff validator for writer and verifier; sweep retires on expires_at; fleet_seams provisions the organ; gap_get and a gap_list that narrows ([fa213ef](https://github.com/willow-memory/willow-mcp/commit/fa213efeece6086b29242cbd42fe7739e0e7b2d0))
...
* **task-submit:** `anticipated_gates` — the upfront ask surface ([0bf23c2](https://github.com/willow-memory/willow-mcp/commit/0bf23c2830a24033e01e456ad829164e0f1fc595))
* **gate:** `perm.*` producer at `server._gate` denial site ([551f39a](https://github.com/willow-memory/willow-mcp/commit/551f39abb7fe66546dbe427b095d51d4a691c286))

## [2.46.0](https://github.com/willow-memory/willow-mcp/compare/v2.45.1...v2.46.0) (2026-09-15)
...
* **db:** get_pg keeps the reason it failed, and the reporters stop guessing ([1f262f8](https://github.com/willow-memory/willow-mcp/commit/1f262f878aaaf9564115098de09a7fb826eed0e8))
