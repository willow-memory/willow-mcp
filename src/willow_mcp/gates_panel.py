...
FRIENDLY_LABELS: dict[str, str] = {
    ...
    "steward_sweep": "Run the steward's tick-time maintenance (seal watch, network authority, envelope sweep, git pull/sync)",
    "steward_read": "See the human-required queue",
    "steward_enqueue": "Flag work for a human",
